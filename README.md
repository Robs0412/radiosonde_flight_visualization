...
## Let's get started
First download the latest Excel file and some CSV example. Later you can also download CSV flight data with via macro or via [radiosondy.info](https://radiosondy.info).

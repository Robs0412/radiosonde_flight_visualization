...
### Introduction:
I started this project to get first insights into Excel VBA - some 'real life data' and the target to visualize the weather balloon flights. 
...
Hint:
- Make sure you switch back to 'Show' in the end of a working session to get back the UI. Other workbooks can be affected.

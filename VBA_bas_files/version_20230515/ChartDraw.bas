...
'Copy & Paste Error of chart objects is detected by '-2147221040' and chart drawing will be performed 5 times in total before FatalError
'Test falscher Name   -2147024809
    
    ErrorNr = Err.Number
    
    DoEvents
    
    If ErrorNr = -2147221040 Then
        Err.Clear
        If RetryCnt = 10 Then
        GoTo FatalError
            ElseIf ChartNr = 1 Then Resume 1
            ElseIf ChartNr = 2 Then Resume 2
            ElseIf ChartNr = 3 Then Resume 3
            ElseIf ChartNr = 4 Then Resume 4
            ElseIf ChartNr = 5 Then Resume 5
            ElseIf ChartNr = 6 Then Resume 6
            ElseIf ChartNr = 7 Then Resume 7
            ElseIf ChartNr = 8 Then Resume 8
            ElseIf ChartNr = 9 Then Resume 9
            ElseIf ChartNr = 10 Then Resume 10
            ElseIf ChartNr = 11 Then Resume 11
            ElseIf ChartNr = 12 Then Resume 12
            ElseIf ChartNr = 13 Then Resume 13
            ElseIf ChartNr = 14 Then Resume 14
            ElseIf ChartNr = 15 Then Resume 15
        End If
    End If
...
FatalError:
    ...
    MsgBox prompt:="Error while drawing charts in " & WS_Name & "!" & vbLf & _
           "(Excel struggles with drawing chart objects)" & vbLf & vbLf & _
           "Please try 'Draw charts' function again, disable" & vbLf & _
           "Error-Msg, continue execut the code or try to debug.", Buttons:=vbInformation, Title:="Information"

...
Sub ProcessImportedSheets()
    ...
    For Counter = 2 To WS_Count
        ...
        'Check if sheet has already been manipulated (see cell Z2), if so skip this sheet
        If Range("Z2").Value = "TRUE" Then
        ...
        Range("Z1").Value = "Sheet processed"
        Range("Z2").NumberFormat = "@"
        Range("Z2").Value = "TRUE"
